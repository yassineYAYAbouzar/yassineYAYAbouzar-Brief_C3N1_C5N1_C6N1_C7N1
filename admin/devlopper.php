...
include 'conect.php';
 ...
 foreach ($stmt as $stm) {
    ...
    <div class="card text-center h-100" style="width: 18rem;">
      ...
      <div class="mt-3 mb-3">
      <form action="" method="post" class="d-inline"><button class="btn btn-danger col-lg-5 Suprime" name= "Suprime" type="submit" value="'. $stm['ID'] .'">Suprime</button></form>
...
if(isset($_POST['Suprime'])){
    $stmt2 = $con->prepare("DELETE  FROM `developpeurs` WHERE ID ={$_POST['Suprime']} ");
    echo "<script>window.location.assign('devlopper.php') ;</script>";
